...
public struct SymmetricKey {
    ...
    /**
     ...
     - Parameter size: The size of the key to generate. You can use one of the standard sizes, like `bits256`, or you can create a key of custom length by initializing a `SymmetricKeySize` i